...
public class PreviousDonationFragment extends Fragment {
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_previous_donation, container, false);
    ...
    void getFoodData() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Config.URL_GET_USER_DONATED_FOOD_BY_ID,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            FoodDonationAdapter adapter = new FoodDonationAdapter(modelList, getActivity(), "PreviousDonation");
