...
//        tvSIGNUP = findViewById(R.id.tvsignup);
        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity.this, VolunteerSignupActivity.class));
            }
        });
    ...
    private void volunteerLog(final String Mobile, final String Password) {
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.URL_VOLUNTEER_LOGIN,
