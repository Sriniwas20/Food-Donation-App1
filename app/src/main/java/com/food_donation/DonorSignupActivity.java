...
public class DonorSignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress = new ProgressDialog(DonorSignupActivity.this);
        ...
        ArrayAdapter<CharSequence> adaptercollege = ArrayAdapter.createFromResource(DonorSignupActivity.this,
        ...
        bregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.equals(""))
                    ...
                    Toast.makeText(DonorSignupActivity.this, "Select State", Toast.LENGTH_SHORT).show();
                else if (city.equals(""))
    ...
    public void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DonorSignupActivity.this);
        builder.setTitle("Add Photo!");
        builder.setItems(items, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int item) {
                boolean result = Utility.checkPermission(DonorSignupActivity.this);
    ...
    public void registerData() {
        mProgress.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.URL_USER_REGISTER,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DonorSignupActivity.this, error.toString(), Toast.LENGTH_LONG).show();
                        mProgress.dismiss();
                    }
                }) {
            @Override
    ...
    private void showAlertBox(final String s, String msg) {
        AlertDialog.Builder alert = new AlertDialog.Builder(DonorSignupActivity.this);
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (s.equals("true")) {
                    startActivity(new Intent(DonorSignupActivity.this, HomePage.class));
                } else if (s.equals("false")) {
